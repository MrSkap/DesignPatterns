...
Функиональный вариант лучше подойдет в небольших иерархичных структурах, затем можно будет вернуться и передалать через классический вариант реализации данного паттерна.
